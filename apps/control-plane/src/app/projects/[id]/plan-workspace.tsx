...
export function PlanWorkspace({ projectId, initialPersonas, initialGoals, initialAccounts, models }: {
  projectId: string; initialPersonas: Persona[]; initialGoals: Goal[]; initialAccounts: AccountView[]; models: RunModel[];
}) {
  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <StartRun projectId={projectId} personas={saved.personas.length} models={models} blocked={dirty ? "Save or discard your changes to the plan first." : undefined} />
    </div>
  );
}
