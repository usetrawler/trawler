...
function render(initialPersonas: Persona[], initialAccounts: AccountView[]) {
  return renderToStaticMarkup(createElement(PlanWorkspace, { projectId: "p1", projectName: "Acme", initialPersonas, initialGoals: [{ id: "g", instruction: "Send an invoice." }], initialAccounts, keyHint: null, canManageKey: true, authorisedBefore: false }));
}
