...
const state = vi.hoisted(() => ({ signedIn: true, found: true, asked: [] as Array<{ orgId: string; projectId: string; page: Page }> }));
...
test("a project of another workspace, or a malformed address, is not found", async () => {
  state.found = false;
