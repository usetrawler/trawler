  ...
  return (
    <div className="app-frame grid min-h-dvh grid-rows-[76px_1fr_46px] overflow-hidden max-[821px]:grid-rows-[64px_auto_46px]">
      ...
      <main className="relative m-auto grid w-[min(1220px,calc(100%-48px))] grid-cols-[minmax(0,1fr)_360px] items-center gap-20 max-[821px]:grid-cols-1 max-[821px]:gap-[55px] max-[821px]:py-[60px] max-[521px]:w-[calc(100%-36px)]">
        <div aria-hidden className="pointer-events-none absolute top-1/2 -right-[2vw] z-0 -translate-y-[54%] text-[clamp(260px,35vw,540px)] leading-[0.75] font-[850] tracking-[-0.1em] text-[color-mix(in_srgb,var(--ink)_4%,transparent)] select-none max-[821px]:relative max-[821px]:top-auto max-[821px]:right-auto max-[821px]:row-start-1 max-[821px]:h-[0.7em] max-[821px]:translate-y-0 max-[821px]:text-[clamp(120px,38vw,190px)] max-[821px]:text-[color-mix(in_srgb,var(--action)_14%,transparent)]">404</div>
        <section className="relative z-10 min-w-0 max-[821px]:row-start-2">
          ...
          <div className="mt-[38px] flex gap-[9px] max-[521px]:flex-col">
        ...
        <aside aria-label="Route check" className="relative z-10 min-w-0 border border-line bg-panel p-5 shadow-[18px_18px_0_var(--soft)] max-[821px]:row-start-3 max-[821px]:shadow-[10px_10px_0_var(--soft)] max-[521px]:shadow-none">
          <div>
